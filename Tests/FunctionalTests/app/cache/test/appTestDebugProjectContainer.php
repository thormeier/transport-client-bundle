...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/transap/Tests/FunctionalTests/app/cache/test/annotations', true);
    }
    ...
    {
        return $this->services['controller_resolver'] = new \Symfony\Bundle\FrameworkBundle\Controller\TraceableControllerResolver($this, new \Symfony\Bundle\FrameworkBundle\Controller\ControllerNameParser($this->get('kernel')), $this->get('debug.stopwatch'), NULL);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/transap/Tests/FunctionalTests/app/Resources');
    }
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/var/www/transap/Tests/FunctionalTests/app/cache/test/jms_serializer'));
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => '/var/www/transap/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer', 'Sensio\\Bundle\\FrameworkExtraBundle' => '/var/www/transap/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer', 'Sensio\\Bundle\\BuzzBundle' => '/var/www/transap/vendor/sensio/buzz-bundle/Sensio/Bundle/BuzzBundle/Resources/config/serializer', 'JMS\\SerializerBundle' => '/var/www/transap/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer', 'Thormeier\\TransportClientBundle' => '/var/www/transap/Resources/config/serializer'));
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/transap/Tests/FunctionalTests/app/cache/test/translations', 'debug' => true));
    }

    /**
     * Gets the 'transport.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Thormeier\TransportClientBundle\Service\Transport A Thormeier\TransportClientBundle\Service\Transport instance.
     */
    protected function getTransport_ClientService()
    {
        $a = $this->get('buzz');
        $b = $this->get('jms_serializer');

        $c = new \Thormeier\TransportClientBundle\Repository\CoordinateRepository();

        $d = new \Thormeier\TransportClientBundle\Repository\LocationRepository($a, $b, 'http://transport.opendata.ch/v1/', 'stations');
        $d->setCoordinateRepository($c);

        $e = new \Thormeier\TransportClientBundle\Repository\PrognosisRepository();

        $f = new \Thormeier\TransportClientBundle\Repository\CheckpointRepository($d, $e);

        $g = new \Thormeier\TransportClientBundle\Repository\ConnectionRepository($a, $b, 'http://transport.opendata.ch/v1/', 'connections');
        $g->setCheckpointRepository($f);
        $g->setSectionRepository(new \Thormeier\TransportClientBundle\Repository\SectionRepository($f, new \Thormeier\TransportClientBundle\Repository\JourneyRepository($f, $d)));
        $g->setServiceRepository(new \Thormeier\TransportClientBundle\Repository\ServiceRepository());

        $h = new \Thormeier\TransportClientBundle\Repository\StopRepository($a, $b, 'http://transport.opendata.ch/v1/', 'stationboard');
        $h->setLocationRepository($d);

        return $this->services['transport.client'] = new \Thormeier\TransportClientBundle\Service\Transport($g, $d, $h);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/transap/Tests/FunctionalTests/app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/transap/Tests/FunctionalTests/app/cache/test',
            'kernel.logs_dir' => '/var/www/transap/Tests/FunctionalTests/app/logs',
            'kernel.bundles' => array(
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
                'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle',
                'SensioBuzzBundle' => 'Sensio\\Bundle\\BuzzBundle\\SensioBuzzBundle',
                'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle',
                'ThormeierTransportClientBundle' => 'Thormeier\\TransportClientBundle\\ThormeierTransportClientBundle',
            ),
            ...
            'debug.container.dump' => '/var/www/transap/Tests/FunctionalTests/app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/transap/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
